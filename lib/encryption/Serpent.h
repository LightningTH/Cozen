#ifndef NEKISAHLOTH_LIB_ENCRYPTION_SERPENT
#define NEKISAHLOTH_LIB_ENCRYPTION_SERPENT
...
class Serpent : public EncryptionBase
{
	public:
		Serpent(ConnectionBase *Connection);
        ~Serpent();
